...
class AnimatedSidebar extends StatefulWidget {
  ...
  const AnimatedSidebar({
    ...
    this.headerImageName,
        ...
        assert(itemIconSize >= 0),
        assert(itemMargin >= 0),
        assert(itemSpaceBetween >= 0),
        assert(headerIcon == null || headerImageName == null);
...
class _AnimatedSidebarState extends State<AnimatedSidebar>
  ...
  Widget _buildHeaderIcon(){
    // image or icon
    return widget.headerIcon != null ? Icon(
      widget.headerIcon,
      color: widget.headerIconColor,
      size: widget.headerIconSize,
    ) : Image.asset(
      widget.headerImageName!,
  ...
  Widget _buildIconTextHeader() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _expanded ? _buildHeaderIcon(): const SizedBox.shrink(),
